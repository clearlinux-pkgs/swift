...
Source0  : http://tarballs.openstack.org/swift/swift-2.10.0.tar.gz
...
Source99 : http://tarballs.openstack.org/swift/swift-2.10.0.tar.gz.asc
...
%prep
%setup -q -n swift-2.10.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1489334949
